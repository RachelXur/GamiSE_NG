...
def Discount_Credit():
    ...
    users = User.query.filter_by(position='Normal').filter_by(qd='Credit/Debit').all()
    form = SimulationForm()
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    <tr>
                                                                        <td align="center" valign="middle">
                                                                            <p style="font-size:18px;line-height:1.5;color:#000000; margin:0px;font-family:&#39;pp-sans-small-regular &#39;,Tahoma,Arial,sans-serif;">Ready for a break from cooking? Pay with Credit/Debit card <span><br></span>and get $10 off your order of $25+.</p>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                                        ...
                                                                                        <td align="center" valign="top">
                                                                                                        ...
                                                                                                        <td align="center" valign="top">
                                                                                                            <table cellpadding="0" cellspacing="0" border="0" align="center" width="100%">
                                                                                                                <tbody>
                                                                                                                    <tr>
                                                                                                                        <td align="left" valign="top" width="120" style="vertical-align:top">
                                                                                                                            <img src="https://images.ctfassets.net/7rifqg28wcbd/2v6CpNafoHUnJNqbnODdnK/ef5847aede0d6143a6cfb862ab3612f4/pp_doordash_icon2.png" alt="Order with Credit/Debit card" width="80" height="80" border="0" style="display:block;text-align:center;font-family:&#39;pp-sans-small-regular&#39;,Tahoma,Arial,sans-serif;font-size:12px;color:#000000" title="Order with Credit/Debit card">
                                                                                                                        </td>
                                                                                                                    </tr>
                                                                                                                </tbody>
                                                                                                            </table>
                                                                                            ...
                                                                                            <table cellpadding="0" cellspacing="0" border="0" width="400" align="right">
                                                                                                <tbody>
                                                                                                    <tr>
                                                                                                        <td align="left" valign="middle" style="padding:0px 0px 10px 0px">
                                                                                                            <p style="margin:0px;font-family:&#39;pp-sans-small-regular&#39;,Tahoma,Arial,sans-serif;font-size:16px;line-height:1.5;color:#6c7378">Pay for your order with Credit/Debit card. Your discount will be automatically applied.</p>
                                                                                                        </td>
                                                                                                    </tr>
                                                                                                </tbody>
                                                                                            </table>
                                                                                        ...
                                                                                        <td align="center" valign="top" style="padding-bottom:0px">
                                                                                            ...
                                                                                            <table cellpadding="0" cellspacing="0" border="0" width="400" align="right">
                                                                                                <tbody>
                                                                                                    <tr>
                                                                                                        <td align="left" valign="middle" style="padding:0px 0px 10px 0px">
                                                                                                            <p style="margin:0px;font-family:&#39;pp-sans-small-regular&#39;,Tahoma,Arial,sans-serif;font-size:16px;line-height:1.5;color:#6c7378">Savings will be reflected on your Credit/Debit card email receipt and account transaction details. You must log in to Credit/Debit card to see your account transaction details.</p>
                                                                                                        </td>
                                                                                                    </tr>
                                                                                                </tbody>
                                                                                            </table>
                                                                                    ...
                                                                                    <tr>
                                                                                        <td align="left" valign="middle" style="padding:20px 0px 0px">
                                                                                            <div style="margin:0px;font-family:&#39;pp-sans-small-regular&#39;,Tahoma,Arial,sans-serif;font-size:13px;line-height:150%;color:#6c7378">
                                                                                                ...
                                                                                                <br><br>
                                                                                                <b>How to Redeem</b>: Once received, activated (where applicable), and qualified for, the Reward will be applied automatically to the Eligible Participant’s Eligible Purchase that qualified for the Reward. The Reward must be redeemed during the Offer Period and may only be redeemed as described in these terms &amp; conditions. Use of the Reward will be reflected on the Eligible Participant’s Credit/Debit card receipt and/or in the transaction details of his/her Credit/Debit card. There is a limit of one (1) Reward per Valid Account. 
                                                                                                <br><br>
                                                                                                <b>Miscellaneous:</b> Redemptions are final, will not be returned, and are subject to review and verification. The Reward has no cash value and cannot be redeemed for cash or withdrawn from the Eligible Participant’s Credit/Debit card account, except in Credit/Debit card sole discretion. If item(s) purchased using a Reward are returned and the Offer Period has expired, Credit/Debit card will first refund the money spent to the payment method used to complete the Eligible Purchase and purchase amount in excess of the money spent (i.e., the value of the Reward) will not be refunded. 
                                                                                                                    If the Offer Period has not expired, the value of the Reward will be returned to the Offers section of the Valid Account and will be available for use by the account holder. Credit/Debit card may provide an alternate reward of equal value if it is unable for any reason to fulfill the Reward. Credit/Debit card reserves the right to cancel, suspend or modify this offer in part or in its entirety at any time without notice, for any reason in its sole discretion. Similar offers may run at the same time; qualification for this offer does not constitute qualification for any other offer. 
                                                                                                                    Credit/Debit card is not responsible and/or liable for any lost, stolen, late, incomplete, illegible, interrupted, delayed, or misdirected e-mail, Reward, or offer-related materials or correspondence or if any Eligible Participant’s e-mail address, Valid Account, or other contact information does not work, is deleted, or is changed without Eligible Participant giving prior written notice to Credit/Debit card. Eligible Participant acknowledges that the Offer is in no way sponsored, endorsed, administered or associated with DoorDash in any way and hereby releases DoorDash from any and all claims in connection with the Offer. 
                                                                                                                    Offer is void where prohibited, if Eligible Purchases are not completed through legitimate channels, or if any offer-related materials are counterfeit, altered, defective, tampered with or irregular in any way. Certain offers may not be transferable. Any questions relating to the offer will be resolved in Credit/Debit card sole discretion and its decisions related to the offer will be final and binding.
                                                                                            </div>
                                                                                        </td>
                                                                                    </tr>
                                                                                    <tr>
