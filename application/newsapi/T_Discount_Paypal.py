...
def Discount_Paypal(userspaypal):
    ...
    for user in userspaypal:  
        sender = 'Paypal <gamise@fastmail.com>'
        receiver = user.email
        ...
        msg['From'] = 'Paypal <gamise@fastmail.com>'
        msg['To'] = user.email
                                    ...
                                    <td align="center" valign="middle" bgcolor="#f2f2f2">
                                        <table border="0" cellpadding="0" cellspacing="0" width="640" align="center" style="min-width:320px;max-width:640px">
                                            <tbody id="m_591092369271924123m_4435424273711280593base"> 
                                                                                ...
                                                                                <tr>
                                                                                    <td align="center" valign="middle" height="70" style="vertical-align:middle">
                                                                                        <a href="""+ url_for('disount', token=uniquelink, _external=True) +""" style="text-decoration:none">
                                                                                            <img src="https://images.ctfassets.net/7rifqg28wcbd/6R5PVEIzYNXxoGB7EtGxiK/f0f3c89fe2979e8909e22cd8dd57b690/PayPal_logo_blue.png" alt="PayPal" title="PayPal" width="140" height="50" border="0" style="display:block;">
                                                                                        </a>
                                                                                    </td>
                                                ...
                                                <tr>
                                                    <td align="center" valign="middle" bgcolor="#019cde" style="background-color:#019cde;padding:40px 35px 50px 35px">
                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                    <td align="center" valign="middle" style="padding-bottom:20px">
                                                                        <h1 style="font-weight:normal;font-size:40px;line-height:1.3;color:#ffffff; margin:0px;font-family:&#39; pp-sans-big-light &#39;,Tahoma,Arial,sans-serif;">Take $10 off your next delivery with DoorDash.</h1>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td align="center" valign="middle">
                                                                        <p style="font-size:18px;line-height:1.5;color:#ffffff; margin:0px;font-family:&#39;pp-sans-small-regular &#39;,Tahoma,Arial,sans-serif;">Ready for a break from cooking? Pay with PayPal <span><br></span>and get $10 off your order of $25+.</p>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td align="center" style="padding:30px 0 0 0">
                                                                        <table width="100%" align="center" cellspacing="0" cellpadding="0" border="0" style="vertical-align:top">
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td align="center" style="font-family:Helvetica,Tahoma,sans-serif;font-size:14px;line-height:60px;font-weight:bold;color:rgb(0,48,135);padding:20px 0px 0px">
                                                                                        <div style="text-align:center;line-height:60px">
                                                                                            <a href="""+ url_for('disount', token=uniquelink, _external=True) +""" style="display:inline-block;width:250px;font-family:&#39;pp-sans-small-regular&#39;,Tahoma,Arial,sans-serif;font-size:18px;font-weight:bold;color:#0070ba;line-height:50px;text-align:center;text-decoration:none;background-color:#ffffff;border-radius:50px" title="Order Now">Order Now</a>
                                                                                        </div>
                                                                                    </td>
                                                                                </tr>
                                                                            </tbody>
                                                                ...
                                                                <tr>
                                                                    <td align="center" valign="middle" style="padding:30px 0px 0px 0px">
                                                                        <p style="font-size:13px;line-height:1.5;color:#ffffff; margin:0px;font-family:&#39;pp-sans-small-regular&#39;,Tahoma,Arial,sans-serif;">Limited offer of 4000 rewards available. Expires 06/01/21. Exclusions apply. <span><a href="""+ url_for('disount', token=uniquelink, _external=True) +""" style="text-decoration:underline;color:rgb(255,255,255);font-family:pp-sans-small-regular,Tahoma,Arial,sans-serif">See offer terms below</a>.</span><span style="display:none" title="Order Now">See offer terms below.</span></p>
                                                                    </td>
                                                                </tr>
                                                            </tbody>
                                                        </table>
                                                                                    ...
                                                                                    <td align="center" valign="top">
                                                                                                    ...
                                                                                                    <td align="center" valign="top">
                                                                                                        <table cellpadding="0" cellspacing="0" border="0" align="center" width="100%">
                                                                                                            <tbody>
                                                                                                                <tr>
                                                                                                                    <td align="left" valign="top" width="120" style="vertical-align:top">
                                                                                                                        <img src="https://images.ctfassets.net/7rifqg28wcbd/2v6CpNafoHUnJNqbnODdnK/ef5847aede0d6143a6cfb862ab3612f4/pp_doordash_icon2.png" alt="Order with Paypal" width="80" height="80" border="0" style="display:block;text-align:center;font-family:&#39;pp-sans-small-regular&#39;,Tahoma,Arial,sans-serif;font-size:12px;color:#000000" title="Order with Paypal">
                                                                                                                    </td>
                                                                                                                </tr>
                                                                                                            </tbody>
                                                                                                        </table>
                                                                                        ...
                                                                                        <table cellpadding="0" cellspacing="0" border="0" width="400" align="right">
                                                                                            <tbody>
                                                                                                <tr>
                                                                                                    <td align="left" valign="middle" style="padding:0px 0px 10px 0px">
                                                                                                        <p style="margin:0px;font-family:&#39;pp-sans-small-regular&#39;,Tahoma,Arial,sans-serif;font-size:16px;line-height:1.5;color:#6c7378">Pay for your order with PayPal. Your discount will be automatically applied.</p>
                                                                                                    </td>
                                                                                                </tr>
                                                                                            </tbody>
                                                                                        </table>
                                                                                    ...
                                                                                    <td align="center" valign="top" style="padding-bottom:0px">
                                                                                        ...
                                                                                        <table cellpadding="0" cellspacing="0" border="0" width="400" align="right">
                                                                                            <tbody>
                                                                                                <tr>
                                                                                                    <td align="left" valign="middle" style="padding:0px 0px 10px 0px">
                                                                                                        <p style="margin:0px;font-family:&#39;pp-sans-small-regular&#39;,Tahoma,Arial,sans-serif;font-size:16px;line-height:1.5;color:#6c7378">Savings will be reflected on your PayPal email receipt and account transaction details. You must log in to PayPal to see your account transaction details.</p>
                                                                                                    </td>
                                                                                                </tr>
                                                                                            </tbody>
                                                                                        </table>
                                                                                ...
                                                                                <tr>
                                                                                    <td align="left" valign="middle" style="padding:20px 0px 0px">
                                                                                        <div style="margin:0px;font-family:&#39;pp-sans-small-regular&#39;,Tahoma,Arial,sans-serif;font-size:13px;line-height:150%;color:#6c7378">
                                                                                            ...
                                                                                            <b>“Eligible Participant”:</b> Open only to residents of Canada who: (1) are eighteen (18) years of age or older; and (2) are holders of a Canadian PayPal account in good standing (“Valid Account”) and (3) receive an authorized email containing the invitation to participate in the offer (eligibility for/those who receive such an email will be determined solely by PayPal). 
                                                                                            <br><br>
                                                                                            <b>“Eligible Purchase(s)”:</b> Purchases made at DoorDash in CAD using a Valid Account. Eligible Purchases do not include: (1) send/receive money transactions (including those marked as a “Goods and Services” payments), (2) charitable donations, (3) purchases made using PayPal.me; (4) Visa Debit or credit card purchases made using the card directly and not through your PayPal account, and (5) PayPal transaction fees. 
                                                                                            <br><br>
                                                                                            <b>“Offer Period”:</b> Starts at 12:01 a.m Eastern Time (“ET”) on February 5, 2021 and ends at 11:50 p.m ET on June 30, 2021. 
                                                                                            <br><br>
                                                                                            <b>“Reward”:</b> $10 CAD voucher that will be viewable in the “Offers” section of the Eligible Participant’s PayPal account for personal or premier accounts. For business accounts, the Reward will only be visible during checkout and on the purchase transaction receipt(s). <b>Only 4000 Rewards are available during the Offer Period; Rewards will no longer be awarded once the limit is reached.</b> 
                                                                                            <br><br>
                                                                                            ...
                                                                                            <br><br>
                                                                                            <b>How to Redeem</b>: Once received, activated (where applicable), and qualified for, the Reward will be applied automatically to the Eligible Participant’s Eligible Purchase that qualified for the Reward. The Reward must be redeemed during the Offer Period and may only be redeemed as described in these terms &amp; conditions. Use of the Reward will be reflected on the Eligible Participant’s PayPal receipt and/or in the transaction details of his/her PayPal account. There is a limit of one (1) Reward per Valid Account. 
                                                                                            <br><br>
                                                                                            <b>Miscellaneous:</b> Redemptions are final, will not be returned, and are subject to review and verification. The Reward has no cash value and cannot be redeemed for cash or withdrawn from the Eligible Participant’s PayPal account, except in PayPal’s sole discretion. If item(s) purchased using a Reward are returned and the Offer Period has expired, PayPal will first refund the money spent to the payment method used to complete the Eligible Purchase and purchase amount in excess of the money spent (i.e., the value of the Reward) will not be refunded. If the Offer Period has not expired, the value of the Reward will be returned to the Offers section of the Valid Account and will be available for use by the account holder. PayPal may provide an alternate reward of equal value if it is unable for any reason to fulfill the Reward. PayPal reserves the right to cancel, suspend or modify this offer in part or in its entirety at any time without notice, for any reason in its sole discretion. Similar offers may run at the same time; qualification for this offer does not constitute qualification for any other offer. PayPal is not responsible and/or liable for any lost, stolen, late, incomplete, illegible, interrupted, delayed, or misdirected e-mail, Reward, or offer-related materials or correspondence or if any Eligible Participant’s e-mail address, Valid Account, or other contact information does not work, is deleted, or is changed without Eligible Participant giving prior written notice to PayPal. Eligible Participant acknowledges that the Offer is in no way sponsored, endorsed, administered or associated with DoorDash in any way and hereby releases DoorDash from any and all claims in connection with the Offer. Offer is void where prohibited, if Eligible Purchases are not completed through legitimate channels, or if any offer-related materials are counterfeit, altered, defective, tampered with or irregular in any way. Certain offers may not be transferable. Any questions relating to the offer will be resolved in PayPal’s sole discretion and its decisions related to the offer will be final and binding.
                                                                                        </div>
                                                                                    </td>
                                                                                </tr>
                                                                                <tr>
                                                                                ...
                                                                                <tr>
                                                                                    <td align="left" valign="middle" style="padding:20px 0px 0px 0px">
                                                                                        <div style="margin:0px;font-family:&#39;pp-sans-small-regular&#39;,Tahoma,Arial,sans-serif;font-size:13px;line-height:150%;color:#6c7378">This email was sent to  
                                                                                            ...
                                                                                            <a href="""+ url_for('disount', token=uniquelink, _external=True) +""" style="color:rgb(0,156,222);text-decoration:underline;font-family:pp-sans-small-regular,Tahoma,Arial,sans-serif" title="Unsubscibe">Unsubscribe
                                                                                            </a>.
                                                                                            ...
                                                                                            <br><br>Please do not reply to this email. We are unable to respond to inquiries sent to this address. For immediate answers to your questions, visit our Help Centre by clicking &#39;Help&#39; located on any PayPal page or email.
                                                                                            <br><br>PayPal is committed to your privacy, learn more about our 
