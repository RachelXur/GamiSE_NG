...
def Facebooknews():
    ...
    users = User.query.filter_by(position='Normal').filter_by(qb='Facebook').all()
    form = SimulationForm()
    ...
    for user in users:
        ...
        # send email
        sender = 'Facebook Daily News <Ray@news.facebook.com>'
        receiver = user.email
        ...
        msg['Subject'] = 'Faceboook - DailyNews'
        msg['From'] = "Facebook Daily News <Ray@news.facebook.com>"
        msg['To'] = user.email
