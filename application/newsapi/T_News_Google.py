                                        ...
                                        <td style="padding: 0px">
                                            <table border="0" style="padding: 0px;width: 650px">
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <img src="https://www.google.com/images/branding/googlelogo/2x/googlelogo_color_92x30dp.png" style="height: 40px;" alt="Google" title="Google"></td>
                                                    </tr>
                                                    <tr>
                                                                                                            ...
                                                                                                            <td style="padding: 0px">
                                                                                                                <table cellpadding="0" cellspacing="0" border="0" width="100%" style="padding: 0px">
                                                                                                                    <tbody>
                                                                                                                        ...
                                                                                                                        <tr>
                                                                                                                            <td style="padding: 0px;">
                                                                                                                                <img src = """+ image +""" style=" width="598.89" height="399.25">
                                                                                                                            </td>
                                                                                                                        </tr>
                                                                                                                        <tr>
